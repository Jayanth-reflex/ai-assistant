                ...
                <div className="px-4 py-3 space-y-4 max-w-full">
                  ...
                  {problemStatementData?.validation_type === "manual" ? (
                    ...
                    <>
                      ...
                      {solutionData && (
                        <ScrollableContent maxHeight="300px">
                          <div className="bg-black/80 text-white rounded-md p-4 my-4 w-full overflow-x-auto">
                            <pre style={{ whiteSpace: 'pre-wrap', wordBreak: 'break-word', fontFamily: 'inherit', fontSize: '1rem', margin: 0 }}>
                              {solutionData}
                            </pre>
                          </div>
                        </ScrollableContent>
