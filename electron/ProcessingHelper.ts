      ...
      try {
        ...
        if (screenshots.length > 0) {
          try {
            ...
            const combinedPrompt = `You are a world-class FAANG senior engineer and technical interviewer agent. You are given one or more screenshots from a coding interview. Your tasks are:
