...
electron_1.contextBridge.exposeInMainWorld("electronAPI", {
    ...
    saveTempFile: (fileName, buffer) => electron_1.ipcRenderer.invoke('save-temp-file', fileName, buffer),
    getCurrentSessionPath: () => electron_1.ipcRenderer.invoke('get-current-session-path'),
    listSessions: () => electron_1.ipcRenderer.invoke('list-sessions'),
});
